    ...
    <div className={`bg-white rounded-lg shadow-2xl overflow-hidden ${className}`}>
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 border-b border-gray-200">
        ...
        <div className="flex gap-1">
          <div className="w-2 h-2 rounded-full bg-[#FF5F56] hover:bg-[#FF4136] transition-colors cursor-pointer"></div>
          <div className="w-2 h-2 rounded-full bg-[#FFBD2E] hover:bg-[#FFB700] transition-colors cursor-pointer"></div>
          <div className="w-2 h-2 rounded-full bg-[#27C93F] hover:bg-[#00D924] transition-colors cursor-pointer"></div>
        </div>

        {/* URL Bar */}
        <div className="flex-1 ml-2 flex items-center">
          <div className="bg-white rounded-md px-3 py-1 text-xs text-gray-500 max-w-[200px] w-full border border-gray-200 flex items-center gap-2">
        ...
        <div className="flex items-center gap-1 ml-1">
          <div className="w-4 h-4 rounded flex items-center justify-center hover:bg-gray-200 transition-colors cursor-pointer">
