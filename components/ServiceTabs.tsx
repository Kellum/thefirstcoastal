...
const serviceLabels: Record<string, string> = {
  ...
  'website': 'Web Design', // Backward compatibility
  'social-media': 'Social Media',
  'seo': 'SEO',
  'design': 'Design',
  'branding': 'Design' // Backward compatibility
};
...
const serviceIcons: Record<string, JSX.Element> = {
  ...
  'website': webDesignIcon, // Backward compatibility
  'social-media': (
    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  'design': designIcon,
  'branding': designIcon // Backward compatibility
};
